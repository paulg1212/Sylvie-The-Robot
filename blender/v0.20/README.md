...
Your model should have a width of 170mm on X axis (corrected). Suitable for build plates of minimum 22cm square. (If you only have a small build plate, you're gonna have to do some slicing, gluing, etc.)
